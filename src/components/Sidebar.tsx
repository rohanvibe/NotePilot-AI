        ...
        <aside className={cn("flex flex-col py-8 px-5 shrink-0 bg-black/40 border-r border-white/5 backdrop-blur-xl w-64", className)}>
            <div className="flex items-center gap-4 px-2 mb-10">
                ...
                <div className="flex flex-col">
                    ...
                    <span className="text-[10px] font-bold text-indigo-400 uppercase tracking-[0.2em] mt-1 pl-0.5 opacity-80">AI Engine v2.0</span>
                </div>
            </div>

            <nav className="flex-1 space-y-1.5">
                <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-2 px-3 opacity-90">Main Menu</p>
                ...
                <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-2 mt-6 px-3 opacity-90">Learn</p>
                ...
                <p className="text-[10px] font-bold text-zinc-400 uppercase tracking-widest mb-2 mt-6 px-3 opacity-90">Intelligence</p>
